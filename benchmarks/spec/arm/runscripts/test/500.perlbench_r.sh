...
for ((i = 0; i < $1; i++)); do
    ...
    if [ $i -eq 0 ]; then
        (
            ...
            ./perlbench_r_base.mytest-64 -I. -I./lib makerand.pl
            ./perlbench_r_base.mytest-64 -I. -I./lib test.pl
        ) &
    else
        (
            cd $BASE_DIR/run_base_test_mytest-64.$extend_i
            ./perlbench_r_base.mytest-64 -I. -I./lib makerand.pl > /dev/null 2>&1
            ./perlbench_r_base.mytest-64 -I. -I./lib test.pl > /dev/null 2>&1
        ) &
    fi
done
