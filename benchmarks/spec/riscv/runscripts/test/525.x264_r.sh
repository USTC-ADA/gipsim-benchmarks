...
for ((i = 0; i < $1; i++)); do
    ...
    if [ $i -eq 0 ]; then
        (
            ...
            ./x264_r_base.mytest --dumpyuv 50 --frames 156 -o BuckBunny_New.264 BuckBunny.yuv 1280x720
        ) &
    else
        (
            cd $BASE_DIR/run_base_test_mytest.$extend_i
            ./x264_r_base.mytest --dumpyuv 50 --frames 156 -o BuckBunny_New.264 BuckBunny.yuv 1280x720 > /dev/null 2>&1
        ) &
    fi
done
