...
for ((i = 0; i < $1; i++)); do
    ...
    if [ $i -eq 0 ]; then
        (
            ...
            ./perlbench_r_base.mytest-m64 -I./lib diffmail.pl 4 800 10 17 19 300
            ./perlbench_r_base.mytest-m64 -I./lib splitmail.pl 6400 12 26 16 100 0
        ) &
    else
        (
            cd $BASE_DIR/run_base_refrate_mytest-m64.$extend_i
            ./perlbench_r_base.mytest-m64 -I./lib checkspam.pl 2500 5 25 11 150 1 1 1 1 > /dev/null 2>&1
            ./perlbench_r_base.mytest-m64 -I./lib diffmail.pl 4 800 10 17 19 300 > /dev/null 2>&1
            ./perlbench_r_base.mytest-m64 -I./lib splitmail.pl 6400 12 26 16 100 0 > /dev/null 2>&1
        ) &
    fi
done
