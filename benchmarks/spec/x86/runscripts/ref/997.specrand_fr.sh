#!/bin/bash
echo "This is a script for 997.specrand_fr.ref with $1 copies (parallel execution)"
...
for ((i = 0; i < $1; i++)); do
    ...
    if [ $i -eq 0 ]; then
        (
            ...
            ./specrand_fr_base.mytest-m64 1255432124 234923
        ) &
    else
        (
            cd $BASE_DIR/run_base_refrate_mytest-m64.$extend_i
            ./specrand_fr_base.mytest-m64 1255432124 234923 > /dev/null 2>&1
        ) &
    fi
done
