#!/bin/bash
echo "This is a script for 519.lbm_r.test with $1 copies (parallel execution)"
...
for ((i = 0; i < $1; i++)); do
    ...
    if [ $i -eq 0 ]; then
        (
            ...
            ./lbm_r_base.mytest-m64 20 reference.dat 0 1 100_100_130_cf_a.of
        ) &
    else
        (
            cd $BASE_DIR/run_base_test_mytest-m64.$extend_i
            ./lbm_r_base.mytest-m64 20 reference.dat 0 1 100_100_130_cf_a.of > /dev/null 2>&1
        ) &
    fi
done
