#!/bin/bash
echo "This is a script for 548.exchange2_r.test with $1 copies (parallel execution)"
...
for ((i = 0; i < $1; i++)); do
    ...
    if [ $i -eq 0 ]; then
        (
            ...
            ./exchange2_r_base.mytest-m64 0
        ) &
    else
        (
            cd $BASE_DIR/run_base_test_mytest-m64.$extend_i
            ./exchange2_r_base.mytest-m64 0 > /dev/null 2>&1
        ) &
    fi
done
