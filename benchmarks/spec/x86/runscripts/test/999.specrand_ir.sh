#!/bin/bash
echo "This is a script for 999.specrand_ir.test with $1 copies (parallel execution)"
...
for ((i = 0; i < $1; i++)); do
    ...
    if [ $i -eq 0 ]; then
        (
            ...
            ./specrand_ir_base.mytest-m64 324342 24239
        ) &
    else
        (
            cd $BASE_DIR/run_base_test_mytest-m64.$extend_i
            ./specrand_ir_base.mytest-m64 324342 24239 > /dev/null 2>&1
        ) &
    fi
done
